...
export default function BudgetFormPage() {
  ...
  const fetchBudgetData = async () => {
    try {
      ...
      router.push("/dashboard/account/budget");
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (isEdit) {
        ...
        router.push(`/dashboard/account/budget/${newBudget.id}`);
        return;
      }
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <Button
            variant="ghost"
            size="icon"
            onClick={() => router.push("/dashboard/account/budget")}
          >
        ...
        <Card className="bg-yellow-50 border-yellow-200">
          <CardContent className="pt-4">
            <p className="text-sm text-yellow-800">
              ...
              <button
                onClick={() =>
                  router.push(`/dashboard/account/budget/${budget.revisionOf?.id}`)
                }
            ...
            <CardContent>
              ...
              <div className="mt-4">
                <Button
                  variant="outline"
                  onClick={() =>
                    router.push(`/dashboard/account/budget/${budgetId}/drill-down`)
                  }
                >
