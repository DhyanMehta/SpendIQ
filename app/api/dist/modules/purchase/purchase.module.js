...
exports.PurchaseModule = PurchaseModule = __decorate([
    (0, common_1.Module)({
        imports: [database_module_1.DatabaseModule, budgeting_module_1.BudgetingModule],
        controllers: [purchase_orders_controller_1.PurchaseOrdersController, vendor_bills_controller_1.VendorBillsController],
        providers: [purchase_orders_service_1.PurchaseOrdersService, vendor_bills_service_1.VendorBillsService],
    })
], PurchaseModule);
