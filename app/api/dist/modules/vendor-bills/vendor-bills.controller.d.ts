...
export declare class VendorBillsController {
    ...
    create(createDto: CreateVendorBillDto, req: any): Promise<{
        purchaseOrder: {
            id: string;
            createdAt: Date;
            updatedAt: Date;
    ...
    findAll(page?: number, limit?: number, search?: string, status?: string, vendorId?: string, startDate?: string, endDate?: string): Promise<{
        data: ({
            purchaseOrder: {
                id: string;
                poNumber: string;
    ...
    registerPayment(id: string, paymentDto: RegisterPaymentDto, req: any): Promise<{
        bill: {
            partner: {
                id: string;
                email: string;
