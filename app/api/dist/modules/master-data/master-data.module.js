...
exports.MasterDataModule = MasterDataModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [analytical_accounts_controller_1.AnalyticalAccountsController],
        providers: [analytical_accounts_service_1.AnalyticalAccountsService, prisma_service_1.PrismaService],
        exports: [analytical_accounts_service_1.AnalyticalAccountsService],
    })
], MasterDataModule);
