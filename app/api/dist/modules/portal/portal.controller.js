...
let PortalController = class PortalController {
    ...
    payInvoice(id, body, req) {
        return this.portalService.payInvoice(id, req.user.id, body === null || body === void 0 ? void 0 : body.amount);
    }
    verifyPayment(id, body, req) {
        return this.portalService.verifyPayment(id, req.user.id, body.razorpay_order_id, body.razorpay_payment_id, body.razorpay_signature, body.amount);
    }
};
